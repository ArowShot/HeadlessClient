package me.arowshot.mineconsole.protocol.protocol109;
...
import me.arowshot.mineconsole.protocol.protocol109.packets.login.C00LoginRejected;
...
import me.arowshot.mineconsole.protocol.protocol109.packets.login.S00Handshake;
import me.arowshot.mineconsole.protocol.protocol109.packets.login.S00LoginStart;
...
public class Protocol109 {
    ...
    public boolean doLogin(Session session, String ip, Short port) {
        ...
        Packet handshake = new S00Handshake(109, this.ip, this.port, 2);
    ...
    public void handlePacket(RawPacket p, int state) throws Exception {
        ...
        switch(packet.getId()) {
            case 0x00: //Keep-alive
                C0BKeepAlive kaPacket = (C0BKeepAlive) packet;
                sendPacket(new S1FKeepAlive(kaPacket.getKAId()));
                break;
            case 0x0F: //Chat
